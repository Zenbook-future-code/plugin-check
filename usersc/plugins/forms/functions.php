  ...
  //note that formField expects an entire object, not an id
    ...
    <div class="form-group">
      ...
      if($o->field_type == "number" || $o->field_type == "tinyint"){
        ...
        value="<?php if($u == 1){echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');}elseif(!empty($_POST)){echo htmlspecialchars($_POST[$o->col], ENT_QUOTES, 'UTF-8');}?>"
        <?php if($o->required == 1){echo "required";}?>
        <?=html_entity_decode($o->input_html)?>
        >
      <?php } //end if int
      ...
      if($o->field_type == "textarea") { ?>
        <textarea name='<?=$o->col?>' id='<?=$o->col?>' class='<?=$o->field_class?>'
          <?php if($o->required == 1){echo "required";}?>   <?=html_entity_decode($o->input_html)?>><?php if($u == 1){echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');}elseif(!empty($_POST)){echo htmlspecialchars($_POST[$o->col], ENT_QUOTES, 'UTF-8');}?></textarea>
        <?php } //end if textarea?>
        ...
        <?php if($o->field_type == "dropdown") {
          ...
          if($o->field_type == "date"){?>
            <input type="date" class="form-control" name="<?=$o->col?>" id="<?=$o->col?>" value="<?php if($u == 1){echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');}elseif(!empty($_POST)){echo htmlspecialchars($_POST[$o->col], ENT_QUOTES, 'UTF-8');}?>">
            <?php

          }
          if($o->field_type == "datetime"){?>
            <input type="datetime-local" class="form-control" name="<?=$o->col?>" id="<?=$o->col?>"
            value="<?php if($u == 1){echo htmlspecialchars(date("Y-m-d\TH:i:s", strtotime($value)), ENT_QUOTES, 'UTF-8');}elseif(!empty($_POST)){echo
